...
namespace DefaultNamespace.Terrain
{
    public static class IslandProfiler
    {
        ...
        public static readonly ProfilerMarker GenerateFeatures = new("Island.GenerateFeatures");
        ...
        public static readonly ProfilerMarker WaterInitialize = new("Water.Initialize");
        public static readonly ProfilerMarker WaterSimulate = new("Water.Simulate");
        public static readonly ProfilerMarker WaterMeshBuild = new("Water.MeshBuild");
        public static readonly ProfilerMarker WaterGroundSample = new("Water.GroundSample");
    }
}
